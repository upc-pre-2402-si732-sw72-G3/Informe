...
<table align="center"  border="1" width="70%" style="text-align:center;">
    ...
    <tr align="center">
        <td rowspan="3">
            <img src="gustavo.jpg" alt=""  style="margin-bottom: 5px;" width="800"/>
        </td>
        <td align="left">
            <b>Nombre y Apellido: </b>
            <br>
