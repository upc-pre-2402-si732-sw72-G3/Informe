...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software.        | **Luza Carhuamaca, Jose Adrian** <br> **TB1:** <br> Durante la elaboración del Capítulo 1, me enfoqué en reconocer la responsabilidad ética y profesional. Para ello, detallé la descripción de la startup y los perfiles de los integrantes del equipo, asegurándome de que cada perfil refleje el compromiso ético de cada miembro. También desarrollé los apartados relacionados con los antecedentes, problemática y el proceso Lean UX, teniendo en cuenta prácticas éticas y transparentes en la recolección y presentación de la información. <br> **TP:** <br> Documenté la planificación de los experimentos del producto de software, asegurándome de que todas las hipótesis formuladas estén alineadas con principios éticos en la ingeniería de software. Esto incluirá la identificación de posibles riesgos éticos y las formas de mitigarlos para garantizar prácticas responsables. <br> <br> **TB2:** <br> Realice el informe de validación de entrevistas, destacando cómo el equipo ha garantizado la ética en el diseño y ejecución de las mismas. Analizaré las respuestas obtenidas para evaluar si las decisiones tomadas reflejan la profesionalidad y la responsabilidad en la ingeniería de software. <br> <br> **TF:** <br> Realice un registro final de las entrevistas diseñadas y llevadas a cabo, resaltando observaciones relacionadas con la responsabilidad ética y profesional del equipo. Además, incluiré recomendaciones específicas que garanticen la ética en la implementación del sistema. <br> <br> <br> <br> **Elsner De La Torre Ugarte, Julio Esteban** <br> **TB1:** <br> Durante el desarrollo del proyecto, adquirí conocimientos en la implementación de arquitecturas de software basadas en el Diseño Orientado al Dominio (DDD), donde pude modelar entidades clave, definir contextos delimitados y aplicar una arquitectura basada en eventos. A lo largo de este proceso, me enfoqué en la responsabilidad ética y profesional, garantizando que las soluciones no solo se alinearan con las necesidades del negocio, sino que también fueran justas, equitativas y respetuosas con los derechos de los usuarios. Además, consideré la importancia de utilizar fuentes y tecnologías que cumplan con los estándares éticos y legales, asegurando un desarrollo de software prudente y confiable. <br> **TP:** <br> Me encargue de definir las condiciones y medidas necesarias para los experimentos, asegurándome de que estas decisiones consideren las implicancias éticas y posibles impactos negativos. Este trabajo incluirá la evaluación de escenarios en los que las condiciones puedan generar conflictos éticos o comprometer la responsabilidad profesional, realice Core Entities Unit Tests, Core Integration Tests, Core Behavior-Driven Development <br> <br> **TB2:** <br> Confirme un análisis estático del código implementado, revisando el cumplimiento de los estándares de codificación ética y profesional. También elaboraré documentación detallada sobre las convenciones de codificación adoptadas por el equipo para promover prácticas responsables.. Realice en el proyecto 7.4. Continuous Monitoring, que comprende: Tools and Practices, Monitoring Pipeline Components, Alerting Pipeline Components, Notification Pipeline Components<br> <br> **TF:** <br> Documentaré la implementación final del sistema, destacando cómo las decisiones de diseño e implementación respetaron los principios éticos y profesionales. Incluiré evidencias de cómo el equipo abordó cualquier desafío ético encontrado durante el desarrollo. todo eso en base me ayudo a realizar para la entrega final Experiment Aftermath & Analysis junto con el Analysis and Interpretation of Results y Re-scored and Re-prioritized Question Backlog, lo que me permiten dar un mayor analisis y profundidad a lo que se hizo durante el trabajo<br> <br> <br> <br> **Miranda Sinarahua, Piero Stephano** <br> **TB1:** <br> Mediante el desarrollo profesional y etico logre identificar las especificacioes y requerimientos necesarios para el desarrollo del trabajo. Contribuí añadiendo mapas e historias de usuarios los cuales se tomaron en cuenta para caracteristicas posteriores mencionadas en el informe. <br> **TP:** <br> Durante el desarrollo del proyecto, logré reconocer y asumir la responsabilidad ética y profesional inherente a la ingeniería de software al implementar pruebas de integración que garantizaron la calidad y coherencia del trabajo realizado. Estas pruebas no solo validaron el correcto funcionamiento del sistema en su conjunto, sino que también aseguraron que las soluciones técnicas fueran confiables, transparentes y alineadas con principios éticos, fortaleciendo la integridad del producto final. <br> <br> **TB2:** <br> En esta entrega del proyecto, reconocí y asumí la responsabilidad ética y profesional al elaborar el As-Is Summary, las Experiment-Ready Questions y las Experiment Cards. Estas herramientas permitieron analizar el estado actual del sistema, formular preguntas clave para guiar los experimentos y estructurar pruebas éticas y objetivas. Este enfoque aseguró que las decisiones tomadas estuvieran fundamentadas y alineadas con principios éticos, contribuyendo a la integridad y sostenibilidad del trabajo realizado. <br> <br> **TF:** <br> En el desarrollo del proyecto, reconocí y asumí la responsabilidad ética y profesional al mostrar tanto el frontend como el backend desarrollado relacionados con el To-Be Sprint Backlog. Este trabajo aseguró la coherencia entre las funcionalidades diseñadas y los objetivos planteados, garantizando que el sistema cumpliera con altos estándares de calidad y se mantuviera alineado con principios éticos y profesionales en todas las etapas del desarrollo. <br> <br> <br> <br> **Landeo Simeón, Favio Sebastián** <br> **TB1:** <br> Realicé el capítulo 5 correspondiente a la implementación del producto, cómo se ejecuta y dónde. <br> **TP:** <br> Durante la planificación del proyecto, realicé el mapeo del escenario To-Be, definí historias de usuario, el Product Backlog y el Impact Mapping. Este proceso me permitió entender la relación entre los objetivos del producto y su impacto ético en los usuarios. Aprendí a identificar cómo las decisiones técnicas pueden influir en el cumplimiento de estándares éticos y a garantizar que el desarrollo del producto mantuviera una perspectiva responsable. <br> <br> **TB2:** <br> En esta fase, trabajé en las historias de usuario To-Be y el Product Backlog. Esto incluyó evaluar cómo estas historias y tareas impactan la experiencia del usuario desde una perspectiva ética. Aprendí a priorizar funcionalidades que fomentaran la transparencia y la accesibilidad, alineando cada decisión con valores profesionales. <br> <br> **TF:** <br> Analicé los resultados de los experimentos realizados, interpreté los datos y re-prioricé el backlog de preguntas. Este análisis me ayudó a comprender cómo los experimentos contribuyen al desarrollo ético del software y cómo las decisiones informadas pueden mejorar la alineación con las necesidades sociales y profesionales. <br> <br> <br> <br> **Poma Espinoza, Gustavo Arturo** <br> **TB1:** <br> Participé activamente en la identificación de problemas éticos y profesionales en el desarrollo del proyecto, asegurando que todas las decisiones técnicas cumplieran con los estándares de la industria y con las regulaciones aplicables. Colaboré en la implementación de prácticas de desarrollo sostenible y en la creación de documentación que refleje el compromiso del equipo con la responsabilidad ética. <br> **TP:** <br> En esta fase, trabajé en la implementación de herramientas y prácticas de Continuous Delivery y Continuous Deployment, además de definir los componentes del pipeline de despliegue. Esto me permitió comprender cómo establecer un flujo automatizado para entregar software de manera eficiente, manteniendo altos estándares éticos en el proceso. Aprendí la importancia de garantizar la calidad del software en cada etapa, respetando las convenciones y estándares de la industria. <br> <br> **TB2:** <br> Realicé un análisis estático del código, evaluando su calidad, seguridad y cumplimiento de estándares éticos y de codificación. Además, supervisé revisiones exhaustivas para identificar áreas de mejora y garantizar que todo el equipo mantuviera un enfoque ético en el desarrollo. Aprendí a identificar riesgos técnicos que podrían afectar la seguridad y cómo mitigarlos a través de revisiones colaborativas. <br> <br> **TF:** <br> Participé en la definición de historias de usuario y el To-Be Product Backlog. Esto implicó analizar cómo las funcionalidades desarrolladas alineaban sus objetivos técnicos con valores éticos. Aprendí a priorizar tareas que fortalecieran la calidad y seguridad del producto, contribuyendo a un desarrollo transparente y profesional. <br>  <br> <br> <br> **Ramirez Alfaro, Miguel Angel** <br> **TB1:** <br> Realice el diseño del modelo de la pagina y lo que seria el inicio del proyecto y su desarrllo con la implementacion en varios capitulos como el 3 y 5 <br> **TP:** <br> En esta fase, trabajé en la implementación de herramientas y prácticas de Continuous Integration, diseñando componentes del pipeline para construcción y pruebas automatizadas. Este trabajo me permitió entender cómo integrar procesos de desarrollo de manera continua, garantizando la calidad del código y alineándolo con estándares éticos y profesionales. Aprendí la importancia de automatizar procesos para reducir errores humanos y asegurar la confiabilidad del software. <br> <br> **TB2:** <br> Diseñé experimentos enfocados en hipótesis, métricas y condiciones, además de realizar cálculos y tomar decisiones sobre escalas. También seleccioné métodos de análisis de datos y elaboré un plan de seguimiento para web y móvil. Este trabajo me enseñó a estructurar experimentos que no solo fueran técnicamente sólidos, sino también éticamente responsables, priorizando transparencia y precisión en los resultados obtenidos.<br> <br> **TF:** <br> Contribuí en la implementación de un ciclo de vida impulsado por experimentos, asegurando la creación de To-Be Sprint Backlogs y presentando evidencias de la página de aterrizaje implementada. Aprendí a gestionar el desarrollo de soluciones basadas en datos experimentales, garantizando que estas estuvieran alineadas con los principios éticos y las expectativas de los usuarios. <br> | A lo largo del desarrollo del proyecto, se reconoció la importancia de asumir la responsabilidad ética y profesional como un pilar fundamental en el ejercicio de la ingeniería de software. Este enfoque permitió garantizar que cada etapa del trabajo, desde la toma de decisiones iniciales hasta el diseño y la implementación, estuviera alineada con principios éticos que promovieran la integridad y la transparencia. Además, el análisis detallado de las implicancias éticas y profesionales permitió anticipar riesgos, identificar soluciones sostenibles y fomentar un impacto positivo en el público objetivo. Se destacó la importancia del uso prudente y responsable de fuentes de información, así como la necesidad de mantener altos estándares profesionales que aseguren un producto de calidad, capaz de generar confianza, optimizar la experiencia del usuario y contribuir a un desarrollo tecnológico más justo y consciente de sus repercusiones a largo plazo. |                                                                                                                |
| Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales.  | **Luza Carhuamaca, Jose Adrian** <br> **TB1:** <br> Al redactar el Capítulo 1, consideré el impacto de las soluciones planteadas en diversos contextos. Desarrollé el perfil de la solución y los segmentos objetivo teniendo en cuenta los efectos potenciales en el ámbito global, económico, ambiental y social. Además, abordé el proceso Lean UX de manera que promoviera una visión integral de las posibles consecuencias de nuestras decisiones en diferentes entornos. <br> **TP:** <br> Identifique y documente los impactos económicos y sociales de las hipótesis iniciales y experimentos planteados, evaluando cómo estos afectan a los usuarios y la sociedad en general. Proporcionaré un análisis crítico sobre la sostenibilidad económica de las soluciones propuestas. <br> <br> **TB2:** <br> Realizaré un análisis detallado del impacto global de los experimentos ejecutados, considerando cómo estos resultados afectan el entorno social, económico y tecnológico. Este análisis incluirá recomendaciones para mitigar impactos negativos. Realice las entrevistas de validacion para poder obtener datos que nos permitieron avanzar y realizar las correcciones para la siguiente entrega. <br> <br> **TF:** <br> Elaboraré un informe final con recomendaciones específicas sobre cómo las soluciones propuestas pueden maximizar su impacto positivo en contextos globales, económicos y sociales, priorizando siempre la sostenibilidad. Las entrevistas finales en base a los cambios realizados  <br> <br> <br> <br> **Elsner De La Torre Ugarte, Julio Esteban** <br> **TB1:** <br> En el proyecto, aprendí a diseñar y desarrollar prototipos tanto para aplicaciones móviles en Android e iOS como para aplicaciones web, aplicando principios de UX/UI. Esto incluye la creación de wireframes, diagramas wireflow, mock-ups y diagramas de flujo de usuario, lo que me permitió entender y optimizar la experiencia del usuario desde las primeras fases del proyecto. Al aplicar estos principios, consideré el impacto global de las soluciones, asegurando que fueran accesibles, intuitivas y alineadas con las necesidades del usuario final, mientras que las decisiones de diseño también reflejaron una consideración consciente de la sostenibilidad ambiental y la responsabilidad social. Además, el proyecto incorporó arquitecturas de software basadas en el Diseño Orientado al Dominio (DDD), asegurando que las soluciones fueran escalables y adaptables a diferentes contextos económicos y culturales, lo que favorece la globalización del software desarrollado. <br> **TP:** <br> Evalue los riesgos ambientales asociados a los experimentos diseñados y las implementaciones propuestas. Este trabajo incluirá un análisis crítico sobre cómo minimizar impactos negativos en el entorno durante el desarrollo del proyecto. <br> <br> **TB2:** <br> Hice un análisis exhaustivo del impacto ambiental de los experimentos realizados, proponiendo estrategias para reducir los tiempos de analisi en la entrega y en el trabajo. <br> <br> **TF:** <br>  Elabore un informe que destaque la contribución del proyecto al desarrollo sostenible, con énfasis en cómo las soluciones implementadas pueden ser adaptadas para generar beneficios globales y minimizar riesgos ambientales. <br> <br> <br> <br> **Miranda Sinarahua, Piero Stephano** <br> **TB1:** <br> Participe en la toma de datos y decision de funcionalidades y caracteristicas las cuales ayudaron a que nuestro proyecto tenga un impacto social y economico en la poblacion. Asi, la solucion tecnologica propuesta conllevara a mejorar los servicios de transporte de la ciudad correspondiente. <br> **TP:** <br> Al desarrollar las pruebas de integración para el proyecto, emití juicios informados que consideraron el impacto de las soluciones en contextos globales, económicos, ambientales y sociales. Estas pruebas garantizaron que el sistema funcionara de manera eficiente y responsable, asegurando su sostenibilidad técnica y su capacidad para generar beneficios tangibles para los usuarios y el entorno en el que será implementado. <br> <br> **TB2:** <br> Al desarrollar las Experiment-Ready Questions y las Experiment Cards, emití juicios informados que consideraron el impacto de las soluciones propuestas en distintos contextos. Estas herramientas permitieron estructurar experimentos que no solo evaluaron la viabilidad técnica, sino también su capacidad para ofrecer beneficios sostenibles y responsables, asegurando que las decisiones tomadas estuvieran alineadas con las necesidades del entorno y los usuarios. <br> <br> **TF:** <br> Al mostrar el frontend y backend relacionados con el To-Be Sprint Backlog, emití juicios informados que consideraron el impacto de las soluciones en varios contextos. Este trabajo garantizó que las funcionalidades desarrolladas fueran eficientes, sostenibles y alineadas con las necesidades de los usuarios, promoviendo un equilibrio entre la innovación tecnológica y su contribución responsable al entorno. <br>  <br> <br> <br> **Landeo Simeón, Favio Sebastián** <br> **TB1:** <br> Realicé el capítulo 5 correspondiente a la implementación del producto, cómo se ejecuta y dónde. <br> **TP:** <br> A través del mapeo del escenario To-Be y el Impact Mapping, evalué cómo las soluciones propuestas influirían en los usuarios a nivel global y social. Aprendí a relacionar objetivos técnicos con beneficios sociales y a considerar el impacto económico en la planificación inicial. <br> <br> **TB2:** <br> Trabajé en las historias de usuario y el Product Backlog desde una perspectiva centrada en el usuario. Esto me permitió anticipar cómo las funcionalidades desarrolladas podrían afectar a diferentes contextos económicos y sociales. Aprendí a alinear los objetivos técnicos con un enfoque global, priorizando soluciones sostenibles. <br> <br> **TF:** <br> Realicé un análisis detallado de los resultados de los experimentos, re-evaluando las preguntas del backlog según su impacto. Este proceso me enseñó a priorizar soluciones que no solo cumplieran con objetivos técnicos, sino que también maximizaran beneficios sociales y económicos en contextos diversos. <br> <br> <br> <br> **Poma Espinoza, Gustavo Arturo** <br> **TB1:** <br> Realicé un análisis exhaustivo de las posibles consecuencias globales y locales de nuestra solución de software, evaluando su impacto en el medio ambiente y en las comunidades que dependen de los servicios de transporte. Participé en la creación de estrategias que maximicen los beneficios sociales y minimicen los impactos negativos. <br> **TP:** <br> Implementé herramientas y prácticas de Continuous Delivery y Continuous Deployment, evaluando cómo los flujos de despliegue impactan en la economía y la sostenibilidad de las operaciones. Aprendí a optimizar procesos para que sean escalables y sostenibles, reduciendo costos operativos y mejorando la eficiencia. <br> <br> **TB2:** <br> Realicé análisis estáticos del código y supervisé revisiones, enfocándome en cómo estas prácticas mejoran la calidad del producto y su impacto global. Aprendí que mantener estándares elevados en la seguridad y calidad del código no solo beneficia al equipo, sino que también genera confianza en los usuarios y mitiga riesgos sociales y económicos. <br> <br> **TF:** <br> Contribuí en la elaboración de historias de usuario y el To-Be Product Backlog, evaluando cómo las funcionalidades propuestas impactarían en diferentes contextos sociales y económicos. Aprendí a priorizar soluciones que equilibraran innovación y sostenibilidad, promoviendo beneficios tanto para los usuarios como para el entorno global. <br> <br> <br> <br> **Ramirez Alfaro, Miguel Angel** <br> **TB1:** <br> Para el trabajo mi parte fue realizar el Cap 5, donde Integré completamente el backend con el frontend, realizando pruebas exhaustivas y asegurando que todas las funcionalidades trabajaran de manera coherente, lo que permitió ofrecer una experiencia de usuario integral y fluida. <br> **TP:** <br> Al diseñar y configurar herramientas de Continuous Integration, evalué cómo estas prácticas afectan la eficiencia y sostenibilidad del desarrollo en contextos globales. Aprendí a optimizar pipelines que no solo mejoran la productividad del equipo, sino que también reducen costos y riesgos económicos, beneficiando a los usuarios y stakeholders. <br> <br> **TB2:** <br> Diseñé experimentos considerando objetivos, métricas clave y métodos de análisis que abordan impactos sociales y económicos. Esto me permitió aprender cómo priorizar decisiones basadas en datos que maximicen los beneficios sociales y económicos, mientras se minimizan riesgos globales y tecnológicos. <br> <br> **TF:** <br> Implementé y documenté To-Be Sprint Backlogs y una landing page basada en experimentos, evaluando su impacto en los usuarios y en el mercado. Aprendí a identificar y comunicar el valor de las soluciones propuestas, asegurando que fueran sostenibles y alineadas con las necesidades de los usuarios en diversos contextos sociales y económicos. <br>  | A lo largo del desarrollo del proyecto, se adoptó una perspectiva integral que permitió emitir juicios informados sobre el impacto de la solución propuesta en diversos contextos globales, económicos, ambientales y sociales. Este enfoque garantizó que el diseño y desarrollo de la aplicación fueran no solo técnicamente sólidos, sino también éticamente responsables, sostenibles y alineados con los objetivos de desarrollo sostenible. El trabajo realizado demostró cómo una solución bien planificada puede beneficiar a los usuarios en actividades cotidianas, optimizando procesos y generando un impacto positivo en la comunidad. Asimismo, el manejo adecuado de la información, basado en fuentes confiables y éticas, fortaleció la credibilidad del producto y destacó la importancia de un enfoque consciente hacia las necesidades de los usuarios y del entorno. El proyecto no solo cumplió con los requisitos técnicos y funcionales, sino que también evidenció cómo una perspectiva holística puede generar soluciones más equilibradas, efectivas y responsables a largo plazo.
 |
---
