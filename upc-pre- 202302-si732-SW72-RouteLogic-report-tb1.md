...
| ---------- | ----------------- | ------------------------------------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | --------- |
| 1          | US-01             | Ver rutas eficientes en tiempo real  | W-01   | - Mostrar rutas actualizadas en tiempo real. <br> - Sugerir rutas alternativas en casos de congestión o problemas de transporte.                             | Done | 5.0 h     |
| 2          | US-02             | Promoción de servicios empresariales | W-02   | - Crear una interfaz para publicar rutas, horarios y tarifas. <br> - Añadir estadísticas de alcance de anuncios.                                             | Done      | 4.5 h     |
| 3          | US-03             | Proporcionar retroalimentación       | W-03   | - Implementar sección para comentarios y calificaciones. <br> - Analizar y almacenar retroalimentación periódicamente.                                       | Done      | 3.5 h     |
| 4          | US-04             | Sugerencias de rutas personalizadas  | W-04   | - Permitir al usuario establecer preferencias de transporte. <br> - Ajustar rutas sugeridas según las preferencias.                                          | Done      | 3.0 h     |
| 5          | US-05             | Encuestas automáticas                | W-05   | - Implementar encuestas después de un número determinado de usos. <br> - Almacenar y analizar datos de encuestas regularmente.                               | Done      | 3.5 h     |
| 6          | US-06             | Recibir notificaciones de retrasos   | W-06   | - Enviar notificaciones automáticas por cambios o retrasos. <br> - Proporcionar alternativas sugeridas en las alertas.                                       | Done | 3.0 h     |
| 7          | US-07             | Gestión de cuentas empresariales     | W-07   | - Aprobar/rechazar solicitudes de empresas. <br> - Diseñar panel para administrar cuentas empresariales.                                                     | Done      | 4.0 h     |
...
| 9          | US-09             | Planificar viajes con anticipación   | W-09   | - Permitir seleccionar fecha y hora para planificar viajes. <br> - Alertar sobre problemas previstos en la hora seleccionada.                                | Done      | 3.5 h     |
| 10         | US-10             | Análisis de patrones de uso          | W-10   | - Registrar datos de uso (frecuencia, rutas buscadas, retroalimentación, etc.). <br> - Generar informes periódicos para identificar oportunidades de mejora. | Done      | 4.5 h     |
